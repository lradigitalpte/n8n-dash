  ...
  org_zumbaton: {
    ...
    tests: [
      ...
      },
      {
        ...
        expectedAnswer: "$30 SGD — 1 token, valid 1 month.",
        mustInclude: ["$30", "1 month"],
        mustNotInclude: ["1 week", "12 Session"],
      },
      {
        id: "adult-4pack",
        category: "Pricing",
        question: "How much is the 4 session pack for adults?",
        expectedAnswer: "$99 SGD — 4 tokens, valid 1 month. Most popular adult pack.",
        mustInclude: ["$99", "99"],
      },
      {
        id: "adult-unlimited",
        category: "Pricing",
        question: "Do you have an unlimited monthly pack?",
        expectedAnswer: "$265 SGD unlimited tokens, valid 1 month.",
        mustInclude: ["$265", "265", "Unlimited"],
        mustNotInclude: ["12 Session", "12 tokens"],
      },
      {
        id: "kids-4pack",
        category: "Pricing",
        question: "Kids class price — my child is 8",
        expectedAnswer: "$20 single or $75 for kids 4-pack. Ages 5–12, valid 1 month, guardian required.",
        mustInclude: ["$20", "75", "1 month"],
        mustNotInclude: ["$74", "$110", "1 week"],
      },
      {
        id: "one-familia",
        category: "Pricing",
      ...
      },
      {
        ...
        expectedAnswer:
          "2 Jalan Klapa, #2-A, Singapore 199314. 8AM–9PM daily. hello@onestepfitness.sg",
        mustInclude: ["Jalan Klapa", "8"],
